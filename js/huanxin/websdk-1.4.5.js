...
/***/ function(module, exports, __webpack_require__) {
	...
	var _login = function _login(options, conn) {
	    ...
	    conn.context.accessToken = options.access_token;//得到token
	    conn.context.accessTokenExpires = options.expires_in;//5101334
...
//	    alert(status+" "+msg+" "+conn+"相关："+Strophe.Status.CONNFAIL+"其他："+Strophe.Status.CONNECTED);
